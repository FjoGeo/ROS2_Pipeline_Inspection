...
class RealSensePublisher(Node):
    ...
    def timer_callback(self):
        ...
        if depth_frame1 and color_frame1:
            self.publish_data(depth_frame1, color_frame1, self.rgb_publisher1, self.depth_publisher1, self.pc_publisher1, "camera1")
        if depth_frame2 and color_frame2:
            self.publish_data(depth_frame2, color_frame2, self.rgb_publisher2, self.depth_publisher2, self.pc_publisher2,  "camera2")
